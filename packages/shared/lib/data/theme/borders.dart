...
const BorderRadiusGeometry defaultAppBarBorderRadius = BorderRadius.vertical(
    top: defaultAppBarTopBorderRadius, bottom: defaultAppBarBottomBorderRadius);

const ShapeBorder defaultAppBarShape =
    ContinuousRectangleBorder(borderRadius: defaultAppBarBorderRadius);
...
const double defaultSignInputBorderRadius = 8;

const BorderSide defaultSignInvalidInputOutLineBorderSide =
    BorderSide(color: defaultSignInvalidInputColor);
